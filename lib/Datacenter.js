...
class Datacenter {
    ...
    repack() {
        this.decrypt('BA08C84E3C557C205A86A6497C564904', '07B0920656502F51DB8E562B328E852B', false);
        this.read();
        this.getFiles();
    ...
    writeFiles() {
        Object.keys(this.files).forEach(file => {
            if (Array.isArray(this.files[file])) {
                //console.log(file, `(x${this.files[file].length})`); display each files contained in a folder
                ...
                //console.log(file); display files being extracted
